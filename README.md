...
For the deployment part, FastAPI is used. The HTML page provides the basic code required to load the data. Please, open terminal and type block code directly or open the prediction.py file then follow the above steps:
